        ...
        <Container>
          <ContentContainer>
            <CompanyName ref={setElementRef(0)}>
              {splitTextToLetters('INVESTMENT MASTERY')}
            </CompanyName>
            
            <MissionText ref={setElementRef(1)}>
              {splitTextToWords('To empower investors worldwide with professional investment education,')}
            </MissionText>
            
            <MissionText ref={setElementRef(2)}>
              {splitTextToWords('providing comprehensive courses that transform financial analysis concepts into practical investing skills.')}
            </MissionText>
            
            <DescriptionText ref={setElementRef(3)} className="description-text">
              {splitTextToChars('Our expertly crafted investment courses cover fundamental analysis, financial statement evaluation, valuation techniques, portfolio management, and market analysis optimization. Each course is designed with hands-on projects, real-world applications, and professional techniques to help you master stock market investing and advance your career in finance, wealth management, and investment analysis.')}
            </DescriptionText>
            
            <ProductsCallToAction ref={setElementRef(4)}>
              <ProductsCard to="/products">
                <ProductsCardTitle>Explore Our Investment Courses</ProductsCardTitle>
                <ProductsCardDescription>
                  Discover comprehensive investment learning programs designed for all skill levels
                </ProductsCardDescription>
                <ProductsCardButton>
                  View Courses
                </ProductsCardButton>
          ...
          <LeadershipContainer>
            ...
            <LeadershipGrid>
              <ClickableLeaderCard ref={setElementRef(6)} onClick={openModal}>
                ...
                <LeaderInfo>
                  <LeaderName>Investment Expert</LeaderName>
                  <LeaderTitle>Investment Masters & Educators</LeaderTitle>
                  <LeaderDescription>
                    Passionate about investing and dedicated to making financial analysis education accessible to everyone. 
                    Creates comprehensive video courses to help others learn and master the art of professional stock market investing.
                  </LeaderDescription>
                </LeaderInfo>
              </ClickableLeaderCard>
            </LeadershipGrid>
          ...
          <ValuesContainer>
            ...
            <ValuesGrid>
              <ValueCard ref={setElementRef(28)}>
                <ValueIcon>🎯</ValueIcon>
                <ValueTitle>Excellence in Investment Education</ValueTitle>
                <ValueDescription>
                  We maintain the highest standards in investment education, constantly updating 
                  our curriculum with the latest techniques and industry best practices.
                </ValueDescription>
              </ValueCard>
              ...
              <ValueCard ref={setElementRef(29)}>
                ...
                <ValueDescription>
                  Investment should be accessible to everyone. We create a supportive environment 
                  where investors from all backgrounds can master fundamental analysis fundamentals.
                </ValueDescription>
              </ValueCard>

              <ValueCard ref={setElementRef(30)}>
                <ValueIcon>⚡</ValueIcon>
                <ValueTitle>Modern Analysis Techniques</ValueTitle>
                <ValueDescription>
                  We stay current with the latest financial analysis tools and platforms, 
                  bringing modern investment practices directly to our students.
                </ValueDescription>
              </ValueCard>

              <ValueCard ref={setElementRef(31)}>
                <ValueIcon>🛡️</ValueIcon>
                <ValueTitle>Professional Investment Standards</ValueTitle>
                <ValueDescription>
                  We prioritize creating sound, well-researched investment decisions, teaching not just how to 
                  analyze stocks, but how to evaluate them thoroughly and strategically.
                </ValueDescription>
              </ValueCard>
              ...
              <ValueCard ref={setElementRef(32)}>
                ...
                <ValueDescription>
                  Investing is an evolving art. We foster continuous learning 
              ...
              <ValueCard ref={setElementRef(33)}>
                ...
                <ValueDescription>
                  We focus on practical storytelling skills that you can apply immediately 
                  in real situations, from business presentations to sales pitches and leadership communication.
                </ValueDescription>
              </ValueCard>
            </ValuesGrid>
            ...
            <MissionStatement ref={setElementRef(34)}>
              ...
              <MissionStatementText>
                To empower the next generation of communicators with world-class education, 
                practical skills, and real-world projects that drive career success. 
                We believe that by making storytelling education accessible and excellent, we can help 
                students create compelling narratives while creating opportunities for everyone 
                to participate in the communication revolution.
              </MissionStatementText>
            </MissionStatement>
          </ValuesContainer>
        </Container>
      ...
      <ModalOverlay isOpen={isModalOpen} onClick={closeModal}>
        <ModalContent isOpen={isModalOpen} onClick={(e) => e.stopPropagation()}>
          ...
          <ModalHeader>
            ...
            <ModalSubtitle>Investment Education Experts</ModalSubtitle>
          </ModalHeader>

          <ModalDescription>
            Our team of professional investment experts is dedicated to 
            transforming careers through comprehensive investment education.
            <br /><br />
            We believe investing should be accessible to everyone, from complete beginners to advanced investors looking to 
            refine their skills. That's why we created comprehensive video courses that break down complex financial analysis concepts 
            into understandable, practical lessons.
            <br /><br />
            Our mission is simple: to help others discover the amazing world of stock market investing and empower them 
            with the knowledge and skills needed to analyze companies effectively and advance their careers. Every course we create is designed with 
            real-world applications in mind, ensuring you can apply what you learn immediately.
            <br /><br />
            Whether you're just starting your investing journey or looking to master advanced fundamental analysis techniques, 
            our expert team is here to guide you every step of the way. Let's explore the incredible possibilities of professional investing together!
          </ModalDescription>
        </ModalContent>
      </ModalOverlay>
    </AboutWrapper>
