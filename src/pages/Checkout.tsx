    ...
    <CheckoutWrapper>
      <Container>
        <CheckoutHeader>
          ...
          <CheckoutSubtitle>Complete your enrollment for premium Investment Mastery courses</CheckoutSubtitle>
        </CheckoutHeader>
          ...
          <CheckoutForm onSubmit={handleSubmit}>
            ...
            <BillingDescriptorSection>
              ...
              <BillingDescriptorText>
                Your credit card will be billed with the following descriptor: <strong>INVESTING-ECOURSES.COM</strong>. This is how the charge will appear on the cardholder's billing statement.
              </BillingDescriptorText>
            </BillingDescriptorSection>
            ...
            <TermsCheckbox>
              <CheckboxContainer>
                ...
                <TermsText>
                  ...
                  Your credit card will be billed with the following descriptor: STORY-ECOURSES.COM. This is how the 
            ...
            <div style={{ fontSize: '0.8rem', color: 'var(--minimal-gray-400)', marginTop: '20px', lineHeight: '1.6' }}>
              ...
              <p style={{ 
                ...
                <div>
                  ...
                  Your credit card will be billed with the following descriptor: <strong>STORY-ECOURSES.COM</strong>. This is how the charge will appear on your billing statement.
                </div>
              </p>
            </div>
          </OrderSummary>
