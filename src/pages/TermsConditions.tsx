    ...
    <Container>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          the terms and provisions of this agreement. These terms apply to all digital Investment Mastery courses, educational content, and 
      ...
      <Section>
        ...
        <Paragraph>
          This Investment Mastery course platform is operated by {COMPANY_INFO.name}. 
      ...
      <Section>
        <SectionTitle>3. Digital Investment Course Pricing</SectionTitle>
        <Paragraph>
          Our Investment Mastery courses are available at the following price points: {formatPrice(6.99)}, {formatPrice(9.99)}, {formatPrice(19.99)}, {formatPrice(29.99)}, {formatPrice(39.99)}, {formatPrice(49.99)}, {formatPrice(59.99)}, {formatPrice(69.99)}, {formatPrice(79.99)}, {formatPrice(89.99)}, and {formatPrice(99.99)}. 
      ...
      <Section>
        ...
        <Paragraph>
          We accept major credit and debit cards for Investment Mastery course purchases. Your payment information is processed securely through our payment processors using 256-bit SSL encryption.
        </Paragraph>
        <Paragraph>
          <strong>Billing Descriptor:</strong> Charges will appear on your credit card statement as "INVESTMENT MASTERY" or "INVESTING-ECOURSES.COM". 
      ...
      <Section>
        ...
        <Paragraph>
          Upon successful payment, you will receive immediate access to your purchased Investment Mastery courses through your account dashboard. 
      ...
      <Section>
        ...
        <Paragraph>
          All Investment Mastery course content, including videos, text, images, and downloadable materials, are the intellectual property of 
      ...
      <Section>
        ...
        <Paragraph>
          Due to the digital nature of our Investment Mastery courses, all sales are final. However, we offer a 7-day satisfaction guarantee. 
      ...
      <Section>
        ...
        <Paragraph>
          We continuously update our Investment Mastery course content to reflect the latest developments in investment analysis techniques and financial strategies. 
      ...
      <Section>
        ...
        <Paragraph>
          {COMPANY_INFO.name} provides Investment Mastery courses for educational purposes only. We make no guarantees about 
          specific outcomes, investment returns, or income generation from course completion. Results may vary based on 
