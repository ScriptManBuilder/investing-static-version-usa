...
const RefundPolicy: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <Section>
        <Paragraph>
          At {COMPANY_INFO.name}, we stand behind the quality of our Investment Mastery courses and want you to be satisfied with your learning experience. 
          This refund policy outlines the terms and conditions for refunds on our digital Investment course purchases.
        </Paragraph>
      </Section>

      <Section>
        <SectionTitle>1. 7-Day Satisfaction Guarantee</SectionTitle>
        <Paragraph>
          We offer a 7-day satisfaction guarantee on all Investment Mastery course purchases. You may request a refund within 7 days
      ...
      <Section>
        ...
        <Paragraph>
          To request a refund for your Investment Mastery course purchase:
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          You will see "INVESTMENT MASTERY" or "INVESTING-ECOURSES.COM" as the refund descriptor on your statement.
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          • Request a course credit for a different Investment Mastery course that better suits your needs<br/>
