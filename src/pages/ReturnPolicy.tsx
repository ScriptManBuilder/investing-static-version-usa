    ...
    <Container>
      ...
      <Section>
        <Paragraph>
          ...
          This policy explains our approach to Investment Mastery course returns and refunds for digital educational content.
        </Paragraph>
      </Section>
      ...
      <Section>
        ...
        <Paragraph>
          Our Investment Mastery courses are digital products delivered instantly upon purchase. Due to the nature of digital 
      ...
      <Section>
        <SectionTitle>2. No Physical Returns Required</SectionTitle>
        <Paragraph>
          Since our Investment Mastery courses are delivered digitally through your online account, there are no physical items to return.
          All course materials, including videos, PDFs, and resources, are accessed through our secure learning platform.
        </Paragraph>
      </Section>

      <Section>
        <SectionTitle>3. 7-Day Satisfaction Guarantee</SectionTitle>
        <Paragraph>
          Instead of returns, we offer a 7-day satisfaction guarantee on all Investment Mastery course purchases. You may request a full refund
      ...
      <Section>
        ...
        <Paragraph>
          To request a refund for your Investment Mastery course:
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          • Request a course credit to switch to a different Investment course<br/>
      ...
      <Section>
        <SectionTitle>8. Course Exchange Option</SectionTitle>
        <Paragraph>
          If you're not satisfied with your current course but would like to try a different Investment Mastery course from our collection,
      ...
      <Section>
        ...
        <Paragraph>
          ...
          and improvements. This ensures ongoing value for your investment in Investment Mastery education.
        </Paragraph>
      </Section>
